...
export default {
    data() {
        return {
            ...
            songSearchQuery: '', // Initialize song search query
            userSearchQuery: '', // Initialize user search query
        };
    },
    async mounted() {
    ...
    methods: {
        ...
        async flagSong(song) {
            ...
            try {
                ...
                // Update song.flag based on newFlagValue
        ...
        async searchUsers() {
            try {
                const response = await fetch(`/search/users?query=${this.userSearchQuery}`);
                const data = await response.json();
            ...
            <table style="width: 100%; border-collapse: collapse; background-color: #fff;">
                ...
                <tbody>
                    <tr v-for="song in songs" :key="song.id" style="border-bottom: 1px solid #ccc;">
                        ...
                        <td style="padding: 10px; text-align: center;">
    <button @click="flagSong(song)" style="padding: 5px 10px; background-color: #007bff; color: #fff; border: none; cursor: pointer;">
